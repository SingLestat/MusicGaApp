...
namespace MusicGaApp.ViewModels
{
    public class Constants
    {
        ...
        public static SqlConnection conn = new SqlConnection("Data Source = gamusicserver.database.windows.net; Initial Catalog = GaMusicDB; User ID = GGteam4; Password = P@ssword!; Connect Timeout = 60; Encrypt = True; TrustServerCertificate = False; ApplicationIntent = ReadWrite; MultiSubnetFailover = False;");
    }
}
